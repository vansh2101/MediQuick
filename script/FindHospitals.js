...
const API_KEY = 'AIzaSyAQANy9_WRe6QpdfYFE8HSiBGE4goovb7Q'
...
async function nearby(lat, lng){
    ...
    try{
        ...
        return ([{latitude: lat, longitude: lng, name:'hospital', vicinity: 'hospital'}])
    }
}


export default function FindHospitals({lat, lng}){
